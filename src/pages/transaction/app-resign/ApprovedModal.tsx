  ...
  const onSubmit = async (data) => {
    try {
      ...
      const result = await Swal.fire({
        title: `Are you sure?`,
        text: `Do you want to approve this resign request?`,
        icon: "warning",
      ...
      const response = await axios.put(
        `${process.env.NEXT_PUBLIC_API_URL}/api/trx/trxResign/approved/${selectedData.id}`,
        {
          ...data,
      ...
      if (response.status == 201) {
        Swal.fire({
          title: "Success!",
          text: "Resign has been successfully Approved",
          icon: "success",
      ...
      Swal.fire({
        title: "Error!",
        text: "Failed to approve resign. Please try again.",
        icon: "error",
        confirmButtonText: "OK",
      });
    }
