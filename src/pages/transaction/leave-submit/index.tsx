...
export default function Home() {
  ...
  const leaveTypeOptions = async (inputValue) => {
    try {
      ...
      const userNrp = Cookies.get("user_nrp");
    ...
    <Main>
      ...
      <Modal isModalOpen={isAddModalOpen}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-group mb-2 flex w-full justify-between gap-4">
            <div className="w-1/2">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <AsyncSelect
                    ...
                    className={clsx(
                      "w-full text-sm",
                      errors.leave_type_id && "border border-red-500 rounded-md"
                    )}
                    styles={{
                      control: (base, state) => ({
                        ...base,
            ...
            <div className="w-1/2">
              <label className="form-label mb-1">Leave Date</label>
              <Controller
                control={control}
                name="date_range"
                render={({ field }) => (
          ...
          <div className="form-group mb-2">
            <label className="form-label mb-1">Leave Reason</label>
            <Controller
              name="leave_reason"
              control={control}
              render={({ field }) => (
                <textarea
                  {...field}
                  className={clsx(
                    "kt-textarea w-full text-sm p-2 border",
                    errors.leave_reason && "border-red-500 rounded-md"
                  )}
                  placeholder="Text input"
                  rows={4}
                  style={{
                    borderColor: errors.leave_reason ? "#EF4444" : "#DBDFE9",
                    boxShadow: "none",
                  }}
                />
              )}
