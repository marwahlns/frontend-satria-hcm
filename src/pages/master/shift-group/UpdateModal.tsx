    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await axios.put(
                `${process.env.NEXT_PUBLIC_API_URL}/api/master/shift-group/${selectedData.id}`,
                {
                    ...data,
            ...
            if (response.status === 200) {
                Swal.fire({
                    text: "Shift group updated successfully",
                    icon: "success",
                    timer: 1500
                });
    ...
    return (
        <Modal isModalOpen={isModalOpen}>
            <div className="modal-header">
                <h3 className="modal-title">Update Data Shift Group</h3>
